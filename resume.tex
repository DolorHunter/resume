...
\section{EXPERIENCE}
    ...
    \item Developed the core of framework and {\bf RESTful API} with {\bf Java} for {\bf Adobe Experience Manager (AEM)}, built components with 
        {\bf HTML}, {\bf CSS} and {\bf JavaScript} for Reimagine, worked with designers on {\bf Figma}.
