...
\section{RELATED SKILLS}  
    ...
    {\sl Languages:} & Python, Java, C/C++, SQL, XML, HTML, Javascript, CSS, 
                        JSON, Shell, LaTeX, Markdown  \\ 
    {\sl Frameworks:} & Spring, React, Django, Qt, Tensorflow, Jekyll \\ 
    {\sl Tools:}  &  Linux, Nginx, Git, SVN, Postman, Navicat, Maven, Crawler, Photoshop
    \end{tabular}   
