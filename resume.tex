...
\section{EXPERIENCE}
    ...
    \vspace{0.00in}	
    \begin{tabbing}
    \hspace{2.7in}\= \hspace{2.2in}\= \hspace{1.6in}\= \kill % set up two tab positions
    {\bf iSoftStone (Microsoft Vendor)} \> {\bf Software Engineer}  \>  
                                    Plano, TX    \` Jul 2023 - Present\\
    \end{tabbing}\vspace{-20pt}      % suppress blank line after tabbing
    % descriptions
    \vspace{+0.1in}
    \begin{itemize} \itemsep 1.5pt %reduce space between items
    \item Developed several {\bf Microsoft AI} projects as a {\bf Microsoft vendor}, e.g. AltNAria, Copyright Scanner, etc.
